...
const Hero = () => {
    return (
        <Container>
            ...
            <Intro>Hi, I'm Tyler. Nice to meet you!</Intro>
            <Summary>I am a web developer passionate about creating products and user experiences that can help shape the future. In the past, I've worn many hats. I've managed a limousine business, screened cargo for the airlines, assisted with directing funerals, serviced aircraft at an FBO, and have been in the grocery industry. I've always loved technology and have aspired to push the boundaries of what is possible.</Summary>
            <SocialLinks>
